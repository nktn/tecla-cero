...
| (同梱はおまけ)19.05mm トラックボール | 1     |BOOTHやAliexpressなどありますが、 [BEEKEEBのオレンジレッド](https://shop.beekeeb.jp/products/19mm-trackball)がおすすめです（ダークグレイの動作も確認しています）。|
...
* (磁石側の方が印刷によって低くなってしまい)電池ケースの前側が浮いてくる時は、電池ケースの磁石の下側に滑り止めシール(厚み1mmくらいのもの:写真のものはGRIPLUSのものをカットして貼った例です)を貼ると安定します
![](../images/trouble_1.jpg)
